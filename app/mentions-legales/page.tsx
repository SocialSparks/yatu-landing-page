...
export const metadata: Metadata = {
  ...
  description: "Éditeur, hébergement, propriété intellectuelle et droit applicable du site Yatu.",
};
    ...
    <LegalPage
      ...
      warning={
        <>
          ...
          réelles de Quantiq Studio (immatriculation, adresse, hébergeur, directeur de publication).
        </>
      }
    >
      <LegalSection title="1. Éditeur du site">
        <P>
          Le présent site est édité par <B>Quantiq Studio</B>, <Todo>forme juridique</Todo>, au
        ...
        <P>
          ...
          <br />
          Adresse électronique : <a href="mailto:hello@yatu.app">hello@yatu.app</a>
        </P>
      </LegalSection>

      <LegalSection title="2. Directeur de la publication">
        <P>
          <Todo>Prénom Nom</Todo>, en qualité de représentant légal de Quantiq Studio.
        </P>
      </LegalSection>
      ...
      <LegalSection title="4. Propriété intellectuelle">
        <P>
          ...
          de Quantiq Studio ou font l&apos;objet d&apos;une autorisation d&apos;usage. Toute
      ...
      <LegalSection title="5. Responsabilité">
        <P>
          ...
          conditions annoncées sont susceptibles d&apos;évoluer jusqu&apos;à la sortie prévue le 9
          septembre 2026. Quantiq Studio met tout en œuvre pour diffuser des informations exactes et
          à jour, sans pouvoir garantir l&apos;absence d&apos;erreur ni la disponibilité permanente
          du site.
        </P>
        <P>
