...
export const LANDING_PAGES: LandingPage[] = [
...

  {
    ...
    og: {
      ...
      subtitle: "Ses limites, une activité pivot, deux tarifs et des retours prévus.",
    },
    cardTitle: "EVG",
    cardSub: "Ses limites, l’activité pivot, les retours.",
    painsTitle: "Les décisions propres à un EVG",
    pains: [
      {
        tool: "heart",
        title: "La blague que le marié subit",
        desc: "Déguisement humiliant, activité qu’il déteste, invité qu’il ne voulait pas voir. Une surprise réussie cache le programme, jamais ses limites.",
      },
      {
        tool: "budget",
        title: "Le tarif unique qui exclut",
        desc: "Certains viennent deux jours, d’autres seulement le samedi. Leur demander la même somme transforme une contrainte d’agenda en discussion d’argent.",
      },
      {
        tool: "send",
        title: "Le retour improvisé à 2 heures",
        desc: "Le logement est loin, personne ne conduit et les derniers transports sont passés. Le trajet retour fait partie du programme autant que l’activité.",
      },
    ],
    stepsTitle: "Construire l’EVG autour d’une activité pivot",
    stepsLede:
      "Le programme se dessine du centre vers les bords : ce qui compte pour le marié d’abord, les options et les extras ensuite.",
    steps: [
      {
        title: "Fais préciser ses limites par une personne de confiance",
        body: "Sans révéler le programme, récupère trois informations : les personnes qu’il veut vraiment là, ce qu’il refuse de faire et le niveau de surprise qu’il accepte. Ce cadre évite de confondre le mettre au centre et le mettre mal à l’aise.",
      },
      {
        title: "Choisis une activité pivot avant de remplir le week-end",
        body: "Match, canyoning, tournoi, barbecue ou concert : une seule activité justifie le déplacement et réunit tout le monde. Garde le reste léger ; ceux qui arrivent tard ou repartent tôt savent ainsi quel moment ne pas manquer.",
      },
      {
        title: "Publie deux tarifs au lieu d’un faux forfait unique",
        body: "Un prix « journée » couvre l’activité pivot et le repas ; un prix « week-end » ajoute le logement et les courses. La part du marié est répartie au prorata, pour que personne ne finance une nuit qu’il ne passe pas sur place.",
      },
      {
        title: "Encaisse l’acompte qui confirme vraiment les présents",
        body: "Fixe une échéance, puis réserve l’activité et le logement sur les virements reçus. Les réponses dans la conversation sont des intentions ; l’acompte est le nombre sur lequel tu peux engager de l’argent.",
      },
      {
        title: "Écris les retours avant les sorties",
        body: "Conducteur désigné, navette réservée, dernier train ou taxis chiffrés : donne un responsable et une solution à chaque soirée. Le plan reste visible du groupe, même quand personne n’a plus envie de chercher une adresse.",
      },
    ],
    timelineTitle: "Huit semaines, de ses limites au retour",
    timeline: [
      { when: "8 semaines avant", what: "Liste des invités et limites du marié confirmées par un proche. Il bloque la date sans connaître le contenu." },
      { when: "7 semaines avant", what: "Activité pivot choisie avec un plan B météo. Le reste du week-end s’organise autour de ce rendez-vous." },
      { when: "6 semaines avant", what: "Tarifs « journée » et « week-end » envoyés ensemble, part du marié incluse dans chacun." },
      { when: "5 semaines avant", what: "Acomptes reçus, puis activité et couchages réservés sur le nombre réel de participants." },
      { when: "1 semaine avant", what: "Conducteurs, navette ou taxis attribués. Chacun connaît son heure d’arrivée et sa solution de retour." },
      { when: "La veille", what: "Le marié reçoit seulement sa tenue utile, l’heure de départ et le point de rendez-vous." },
    ],
    costsTitle: "Deux tarifs pour deux niveaux de présence",
    costsLede:
      "Le tarif journée rend l’événement accessible ; le tarif week-end paie les coûts engagés par ceux qui dorment sur place. Dans les deux cas, annonce la part du marié dès le départ.",
    costs: [
      {
        format: "Une journée : activité et repas",
        range: "70 à 130 €",
        detail:
          "Activité pivot entre 35 et 70 €, repas et part du marié. C’est le tarif de ceux qui rejoignent le groupe le samedi sans payer le gîte du vendredi soir.",
      },
      {
        format: "Week-end en France, gîte loué",
        range: "180 à 320 €",
        detail:
          "Deux nuits, activité pivot, courses et un repas dehors. Sépare ce socle des extras improvisés pour que le prix annoncé reste vrai jusqu’au dimanche.",
      },
      {
    ...
    costsNote:
      "Fourchettes indicatives pour la France, hors vacances scolaires. Fais apparaître trois lignes séparées : le socle commun, les options choisies et la part du marié. Cette présentation permet à celui qui ne dort pas sur place de payer sa juste part sans ouvrir une négociation au retour.",
    mistakes: [
      {
        title: "Confondre surprise et humiliation",
        desc: "La limite est simple : le marié peut ne pas connaître l’activité, mais l’organisateur doit savoir qu’il consent à ce type de situation. Une vidéo drôle pour neuf personnes et pénible pour lui n’est pas un souvenir réussi.",
      },
      {
        title: "Facturer le même forfait à tous",
        desc: "Celui qui arrive samedi et repart avant la nuit ne doit ni son lit ni le petit-déjeuner du dimanche. Écris les deux tarifs avant les réponses : personne n’aura à défendre son cas après coup.",
      },
      {
        title: "Traiter le retour comme un détail",
        desc: "Après une soirée loin du logement, la question n’est plus qui veut conduire mais quelle solution était prévue. Nomme les conducteurs ou réserve le transport avant de réserver la table.",
      },
    ],
    modulesTitle: "Un socle commun, des options et aucun retour flou",
    modulesLede: "Le budget distingue les présences ; le planning garde l’activité pivot et les transports lisibles jusqu’au bout de la nuit.",
    modules: ["budget", "planning", "infos", "secret", "img"],
    faq: [
      {
        q: "Que faut-il demander au marié sans gâcher la surprise ?",
        a: "Sa liste d’invités indispensable, les activités ou situations qu’il refuse et ses contraintes physiques ou alimentaires. Tu peux obtenir ces réponses par son témoin ou son conjoint sans révéler le lieu ni le programme. La surprise porte sur le scénario, pas sur son consentement.",
      },
      {
        q: "Comment calculer deux tarifs pour un EVG ?",
        a: "Mets l’activité pivot, le repas commun et une part du marié dans le tarif journée. Ajoute au tarif week-end le logement, les courses et les transports propres aux nuits sur place. Les options individuelles restent à la charge de ceux qui les choisissent.",
      },
      {
        q: "Que faire si certains ne peuvent venir qu’une partie du week-end ?",
        a: "Place l’activité pivot au milieu du samedi et publie dès l’invitation un tarif « journée » distinct. Ils rejoignent ainsi le moment principal sans financer les couchages, tandis que les coûts fixes du week-end restent assumés par ceux qui les ont confirmés.",
      },
      {
        q: "Comment choisir l’activité principale d’un EVG ?",
        a: "Pars des goûts et des limites du marié, puis vérifie trois contraintes : tout le groupe peut-il y participer, existe-t-il un repli météo et ceux qui viennent à la journée peuvent-ils arriver à temps ? L’activité la plus spectaculaire n’est pas forcément celle qui rassemble.",
      },
      {
        q: "Comment organiser les retours après la soirée ?",
        a: "Choisis avant le départ entre conducteurs désignés, navette, taxis réservés ou logement accessible à pied. Écris la solution, les horaires et le responsable dans le programme. Un budget transport prévu est toujours moins cher qu’une décision prise au milieu de la nuit.",
      },
      {
